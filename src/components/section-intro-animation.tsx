        ...
        <>
            ...
            <div className={cn(
                ...
                <div 
                    ...
                    style={{ animation: 'scale-up-fade 2.5s cubic-bezier(0.25, 1, 0.5, 1) forwards' }}
                >
                   {icon}
                </div>

                {/* Text animation */}
                <div className="mt-8 text-center" style={{ animation: 'fade-in-up 1.5s ease-out 1s forwards', opacity: 0 }}>
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight">{title}</h1>
                    <p className="text-muted-foreground mt-2 text-lg" style={{ animation: 'fade-in-up 1.5s ease-out 1.5s forwards', opacity: 0 }}>
                        {subtitle}
                    </p>
                </div>
            </div>
